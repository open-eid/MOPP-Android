...
public class Constants {
    public static final String CONTAINER_NAME_KEY = "ee.ria.DigiDoc.containerName";
    public static final String CONTAINER_PATH_KEY = "ee.ria.DigiDoc.containerPath";

    public static final String APP_PACKAGE_NAME = "ee.ria.DigiDoc";
