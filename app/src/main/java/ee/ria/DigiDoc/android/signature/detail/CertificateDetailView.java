...
public final class CertificateDetailView extends CoordinatorLayout {
    ...
    private void setData(X509Certificate certificate) {
        ...
        if (certificateHolder != null) {
            TextView certificateDetailSubjectDataTitle = findViewById(R.id.certificateDetailSubjectDataTitle);
            TextView certificateDetailCountryTitle = findViewById(R.id.certificateDetailCountryTitle);
            TextView certificateDetailOrganizationTitle = findViewById(R.id.certificateDetailOrganizationTitle);
            TextView certificateDetailOrganizationalUnitTitle = findViewById(R.id.certificateDetailOrganizationalUnitTitle);
            TextView certificateDetailCommonNameTitle = findViewById(R.id.certificateDetailCommonNameTitle);
            TextView certificateDetailSurnameTitle = findViewById(R.id.certificateDetailSurnameTitle);
            TextView certificateDetailGivenNameTitle = findViewById(R.id.certificateDetailGivenNameTitle);
            TextView certificateDetailSerialCodeTitle = findViewById(R.id.certificateDetailSerialCodeTitle);
            TextView certificateDetailIssuerDataTitle = findViewById(R.id.certificateDetailIssuerDataTitle);
            TextView certificateDetailIssuerCountryTitle = findViewById(R.id.certificateDetailIssuerCountryTitle);
            TextView certificateDetailIssuerOrganizationTitle = findViewById(R.id.certificateDetailIssuerOrganizationTitle);
            TextView certificateDetailIssuerCommonNameTitle = findViewById(R.id.certificateDetailIssuerCommonNameTitle);
            TextView certificateDetailIssuerEmailTitle = findViewById(R.id.certificateDetailIssuerEmailTitle);
            TextView certificateDetailIssuerOrganizationIdentifierTitle = findViewById(R.id.certificateDetailIssuerOrganizationIdentifierTitle);
            TextView certificateDetailSerialNumberTitle = findViewById(R.id.certificateDetailSerialNumberTitle);
            TextView certificateDetailVersionTitle = findViewById(R.id.certificateDetailVersionTitle);
            TextView certificateDetailSignatureAlgorithmTitle = findViewById(R.id.certificateDetailSignatureAlgorithmTitle);
            TextView certificateDetailSignatureParametersTitle = findViewById(R.id.certificateDetailSignatureParametersTitle);
            TextView certificateDetailNotValidBeforeTitle = findViewById(R.id.certificateDetailNotValidBeforeTitle);
            TextView certificateDetailNotValidAfterTitle = findViewById(R.id.certificateDetailNotValidAfterTitle);
            TextView certificateDetailPublicKeyInfoTitle = findViewById(R.id.certificateDetailPublicKeyInfoTitle);
            TextView certificateDetailPublicKeyAlgorithmTitle = findViewById(R.id.certificateDetailPublicKeyAlgorithmTitle);
            TextView certificateDetailPublicKeyParametersTitle = findViewById(R.id.certificateDetailPublicKeyParametersTitle);
            TextView certificateDetailPublicKeyPKTitle = findViewById(R.id.certificateDetailPublicKeyPKTitle);
            TextView certificateDetailPublicKeyKeyUsageTitle = findViewById(R.id.certificateDetailPublicKeyKeyUsageTitle);
            TextView certificateDetailSignatureTitle = findViewById(R.id.certificateDetailSignatureTitle);
            TextView certificateDetailExtensionsTitle = findViewById(R.id.certificateDetailExtensionsTitle);
            TextView certificateDetailFingerprintsTitle = findViewById(R.id.certificateDetailFingerprintsTitle);
            TextView certificateDetailFingerprintsSHA256Title = findViewById(R.id.certificateDetailFingerprintsSHA256Title);
            TextView certificateDetailFingerprintsSHA1Title = findViewById(R.id.certificateDetailFingerprintsSHA1Title);


            certificateDetailSubjectDataTitle.setText(R.string.subject_name);
            certificateDetailCountryTitle.setText(R.string.country_or_region);
            certificateDetailOrganizationTitle.setText(R.string.organization);
            certificateDetailOrganizationalUnitTitle.setText(R.string.organizational_unit);
            certificateDetailCommonNameTitle.setText(R.string.common_name);
            certificateDetailSurnameTitle.setText(R.string.surname);
            certificateDetailGivenNameTitle.setText(R.string.given_name);
            certificateDetailSerialCodeTitle.setText(R.string.serial_number);
            certificateDetailIssuerDataTitle.setText(R.string.issuer_name);
            certificateDetailIssuerCountryTitle.setText(R.string.country_or_region);
            certificateDetailIssuerOrganizationTitle.setText(R.string.organization);
            certificateDetailIssuerCommonNameTitle.setText(R.string.common_name);
            certificateDetailIssuerEmailTitle.setText(R.string.email_address);
            certificateDetailIssuerOrganizationIdentifierTitle.setText(R.string.other_name);
            certificateDetailSerialNumberTitle.setText(R.string.serial_number);
            certificateDetailVersionTitle.setText(R.string.version);
            certificateDetailSignatureAlgorithmTitle.setText(R.string.signature_algorithm);
            certificateDetailSignatureParametersTitle.setText(R.string.parameters);
            certificateDetailNotValidBeforeTitle.setText(R.string.not_valid_before);
            certificateDetailNotValidAfterTitle.setText(R.string.not_valid_after);
            certificateDetailPublicKeyInfoTitle.setText(R.string.public_key_info);
            certificateDetailPublicKeyAlgorithmTitle.setText(R.string.algorithm);
            certificateDetailPublicKeyParametersTitle.setText(R.string.parameters);
            certificateDetailPublicKeyPKTitle.setText(R.string.public_key);
            certificateDetailPublicKeyKeyUsageTitle.setText(R.string.key_usage);
            certificateDetailSignatureTitle.setText(R.string.signature);
            certificateDetailExtensionsTitle.setText(R.string.extensions);
            certificateDetailFingerprintsTitle.setText(R.string.fingerprints);
            certificateDetailFingerprintsSHA256Title.setText(R.string.sha_256);
            certificateDetailFingerprintsSHA1Title.setText(R.string.sha_1);
