...
public final class CertificateDetailView extends CoordinatorLayout {
    ...
    private void setData(X509Certificate certificate) {
        ...
        if (certificateHolder != null) {
            ...
            certificateDetailSubjectDataTitle.setText("Subject Name");
            certificateDetailCountryTitle.setText("Country or Region");
            certificateDetailOrganizationTitle.setText("Organization");
            certificateDetailOrganizationalUnitTitle.setText("Organizational Unit");
            certificateDetailCommonNameTitle.setText("Common Name");
            certificateDetailSurnameTitle.setText("Surname");
            certificateDetailGivenNameTitle.setText("Given Name");
            certificateDetailSerialCodeTitle.setText("Serial Number");
            certificateDetailIssuerDataTitle.setText("Issuer Name");
            certificateDetailIssuerCountryTitle.setText("Country or Region");
            certificateDetailIssuerOrganizationTitle.setText("Organization");
            certificateDetailIssuerCommonNameTitle.setText("Common Name");
            certificateDetailIssuerEmailTitle.setText("Email address");
            certificateDetailIssuerOrganizationIdentifierTitle.setText("Other Name");
            certificateDetailSerialNumberTitle.setText("Serial Number");
            certificateDetailVersionTitle.setText("Version");
            certificateDetailSignatureAlgorithmTitle.setText("Signature Algorithm");
            certificateDetailSignatureParametersTitle.setText("Parameters");
            certificateDetailNotValidBeforeTitle.setText("Not Valid Before");
            certificateDetailNotValidAfterTitle.setText("Not Valid After");
            certificateDetailPublicKeyInfoTitle.setText("Public Key Info");
            certificateDetailPublicKeyAlgorithmTitle.setText("Algorithm");
            certificateDetailPublicKeyParametersTitle.setText("Parameters");
            certificateDetailPublicKeyPKTitle.setText("Public Key");
            certificateDetailPublicKeyKeyUsageTitle.setText("Key Usage");
            certificateDetailSignatureTitle.setText("Signature");
            certificateDetailExtensionsTitle.setText("Extensions ");
            certificateDetailFingerprintsTitle.setText("Fingerprints ");
            certificateDetailFingerprintsSHA256Title.setText("SHA-256");
            certificateDetailFingerprintsSHA1Title.setText("SHA-1");
