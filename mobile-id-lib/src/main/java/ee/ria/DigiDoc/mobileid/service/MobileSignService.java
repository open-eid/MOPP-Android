...
public class MobileSignService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        timeout = 0;
        @NonNull MobileCreateSignatureRequest request = getRequestFromIntent(intent);
        ...
        try {
            ...
            if (!responseWrapper.isSuccessful()) {
                ...
                @NonNull String base64Hash = containerWrapper.prepareSignature(getCertificatePem(response.getCert()));
